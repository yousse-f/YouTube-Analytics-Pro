...
retry logic with exponential backoff for resilient external service calls.
"""
...
# HTTP/API calls (requests, connection errors)
...
retry_selenium_operations = create_retry_decorator(
    exception_types=(
        WebDriverException,
        TimeoutException,
    ),
    stop_attempts=2,  # Fewer retries for Selenium (slower operations)
)
